...
CUDA_VISIBLE_DEVICES=0 python -m heareval.embeddings.runner hear_configs.axlstm_tiny_200_16x4 --tasks-dir ${tasks_dir} --embeddings-dir ${output_dir}/${pretrain_ds}
