...
PT_AXLSTM_MODEL_DIR = os.environ.get("PT_AXLSTM_MODEL_DIR")


config_path = "configs.axlstm_small_200_16x4"
precision = "float16"
RUN_ID = 1
model_path = os.path.join(PT_AXLSTM_MODEL_DIR, f"axlstm_small_200_16x4_4x256_fp16_r{RUN_ID}")
