# Taken from https://github.com/NX-AI/vision-lstm/blob/main/vision_lstm/vision_lstm.py
...
class ViLBlock(nn.Module):
    def __init__(self, dim, direction, drop_path=0.0, norm_bias=False, expansion_factor=2):
        super().__init__()
        self.dim = dim
        self.direction = direction
        ...
        self.layer = ViLLayer(dim=dim, direction=direction, expansion=expansion_factor)
